...
// Named, reusable component profiles (Motor today; Battery/Cable/Inverter are
// the same shape as a future `type`) that get pulled into MULTIPLE calculators
...
export type ComponentProfileType = 'motor';
